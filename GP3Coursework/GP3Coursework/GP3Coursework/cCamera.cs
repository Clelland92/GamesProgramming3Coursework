...
namespace GP3Coursework
{
    class cCamera
    {
        public CamMode currentCamMode = CamMode.chase; //setting default camera mode to chase camera 
        ...
        public void ResetCamera()
        {
            ...
            offsetDistance = new Vector3(50, 50, 50); // set the distance the camera should be from the object,
        ...
        /// </summary>
        /// <param name="chaseObjWorld"> The object that we want to follow's world matrix,</param>
        public void Update(Matrix chaseObjWorld)
        {
            HandleInput();
            UpdateViewMatrix(chaseObjWorld); //pass the view matrix the objects world matrix to allow tracking.
        }
        ...
        /// </summary>
        /// <param name="chasedObjWorld"> Used for the third person camera, this ius the world matrix of the world
        /// we wish to follow.</param>
        private void UpdateViewMatrix(Matrix chasedObjWorld)
        {
            ...
            switch (currentCamMode)
            {
                ...
                case CamMode.chase:
                    ...
                    cameraRotation.Forward.Normalize();
                    chasedObjWorld.Right.Normalize();
                    chasedObjWorld.Up.Normalize();
                    ...
                    desiredTarget = chasedObjWorld.Translation;
                    ...
                    target += chasedObjWorld.Right * yaw;
                    target += chasedObjWorld.Up * 0.5f;
                    ...
                    desiredPosition = Vector3.Transform(offsetDistance, chasedObjWorld);
